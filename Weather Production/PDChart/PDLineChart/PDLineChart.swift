...
class PDLineChartDataItem {
    //optional
    var axesColor: UIColor = UIColor.whiteColor()             //坐标轴颜色
    var axesTipColor: UIColor = UIColor.whiteColor()         //坐标轴刻度值颜色
    var chartLayerColor: UIColor = UIColor.whiteColor()    //折线的颜色
    var chartFillColor:UIColor = UIColor.whiteColor()
...
class PDLineChart: PDChart {
    ...
    override func strokeChart() {
        ...
        chartLayer.fillColor = self.dataItem.chartFillColor.CGColor
